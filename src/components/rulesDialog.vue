      ...
      <template #default>
        ...
        <div class="rules-content" v-else>
          ...
          <div class="rules-content-item">
            <p>活动内容：</p>
            <p class="text">
              活动期间，用户通过完成指定任务获得植物生长值，植物生长值达到85%，可获得【50元代金券1张（满300元可用）】，植物生长值达到100%，可获得【春日限定礼品1份】。<br />植物生长值达到85%后，将开放信息登记入口，用户可自行前往登记，登记信息需与砂之船（重庆璧山）奥莱会员会员注册信息保持一致。50元代金券将于活动结束后1个工作日后发放至手机号码对应的夜奥莱会员账户中；春日限定礼品请于2025年3月28日至3月30日前往砂之船（重庆璧山）奥莱会员中心，凭登记信息领取。
            </p>
          </div>
          <div class="rules-content-item">
            <p>做任务得生长值：</p>
          ...
          <div class="rules-content-item">
            ...
            <p class="text">
              ...
              2、在活动截止前，完成「夜奥莱」相关任务所获得的生长值，将在1个工作日后发放，于游戏主页面中生长值进度条中体现。<br />
